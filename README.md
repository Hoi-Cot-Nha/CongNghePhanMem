...
Plaintext
src/
├── Connection/      # Chứa ConnectDB.java (Quản lý kết nối SQL Server)
├── Controller/      # Xử lý Logic điều hướng và tương tác dữ liệu
├── Dao/             # Data Access Object - Thao tác CRUD trực tiếp với DB
├── Model/           # Định nghĩa các Entity (HocSinh, GiaoVien, Auth...)
├── View/            # Toàn bộ giao diện người dùng (Panels & Frames)
└── com/qlhs/main/   # MainFormNew.java (Điểm khởi chạy ứng dụng)
🛠️ Hướng dẫn Cài đặt
Cơ sở dữ liệu:
